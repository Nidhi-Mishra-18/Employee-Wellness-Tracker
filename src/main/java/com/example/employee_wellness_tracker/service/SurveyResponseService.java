...
public class SurveyResponseService {
     ...
     */
    @Transactional
    public SurveyResponse updateResponse(Long responseId, SurveyResponse updatedResponse) {
        ...
        existingResponse.setAnswers(updatedResponse.getAnswers()); // Update answers
